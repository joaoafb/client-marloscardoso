...
async function sendData(data) {
    try {
        const response = await fetch("https://api.marloscardoso.com/api/marloscardoso/loginusuario", {
            method: "POST",
            headers: {
...
async function sendDataCadastro(dados) {
    try {
        const response = await fetch("https://api.marloscardoso.com/api/marloscardoso/cadastrocliente", {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
